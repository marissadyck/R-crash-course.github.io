...
**Data frame** - Data frames are a special type of list in which each list element is a vector of equal length. Each list element in a data frame is also known as a column. 
...
**Fixed effects** - Are things we have measured that we expect to influence our observations in some predictable way (i.e. independent/explanatory variables).   
...
**Generalized linear mixed effects models** - GLMMs or sometimes referred to as hierarchical models, and extension of GLMS that allow you to model dependence among correlated observations through the use of random (mixed) effect terms.  
