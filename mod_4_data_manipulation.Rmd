...
Using the turtles_no_na data, overwrite the data and make a new variable called "size_class" based on the "weight" variable using `case_when()` whereby
...
[--go to next module--](mod_5_purrr.html)